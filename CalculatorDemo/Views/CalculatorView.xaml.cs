...
namespace MVVMCalculatorDemo.Views
{
    /// <summary>
    ///     Interaction logic for MainWindow.xaml
    /// </summary>
    public sealed partial class CalculatorView : Window
    {
        ...
        {
            private readonly CalculatorView _window;
            private string _args;

            public PaperTrail(CalculatorView window)
            {
                _window = window;
            }
